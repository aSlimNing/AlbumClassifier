package org.tensorflow.photoclassifier.dao;
...
public class DataBaseOperator {
    ...
    public DataBaseOperator(Context context, String dbName, int dbversion) {
        this.context = context;
        this.dbHelper = new DatabaseHelper(context, dbName, null, dbversion);
